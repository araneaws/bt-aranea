...
$options['db_host'] = 'bopo.aranea.ws';
$options['db_port'] = '3306';
$options['db_passwd'] = 'HZ4LP22nBM';
$options['db_name'] = 'demobintangtim_1';
$options['db_user'] = 'demobintangtim_1';
